...
export default function HomeUserSelect(options: Options) {
  return (
    <div style={{cursor: "default"}} className="rounded-lg overflow-y-scroll max-h-32 min-h-24 bg-slate-400 hover:bg-indigo-300 duration-200 hover:scale-105 transition ease-in-out">
