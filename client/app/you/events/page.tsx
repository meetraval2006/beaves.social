...
export default function Home() {
  ...
  return (
    <>
      ...
      <aside
        id="default-sidebar"
        className="fixed rows-2 border-l border-l-orange-200 top-0 right-0 z-40 w-3/12 h-screen transition-transform -translate-x-full sm:translate-x-0 bg-black"
        aria-label="Sidebar"
      >
