...
export default function Home() {
  ...
  return (
    ...
    {/* <div className="sm:ml- flex flex-col h-screen">
      <div className="basis-1/12 border-b border-b-orange-200 pl-6 py-4">
        <div className="flex items-center">
          ...
          <div className="text-xl font-semibold text-orange-300">User #{pathname.split("/")[3]}</div>
        </div>
      </div>
      ...
      <div className="basis-10/12 p-4 flex flex-col justify-end">
        <div className="px-2 py-1">
          <div className="float-right flex items-center columns-2">
            <div style={{cursor: "default"}} className="text-sm mr-2 text-orange-400">7:01 pm</div>
            <div className="bg-orange-500 py-2 px-4 rounded-full">Hi</div>
          </div>
        </div>
        <div className="px-2 py-1">
          <div className="float-right flex items-center columns-2">
            <div style={{cursor: "default"}} className="text-sm mr-2 text-orange-400">7:01 pm</div>
            <div className="bg-orange-500 py-2 px-4 rounded-full">How are you</div>
          </div>
        </div>
        <div className="px-2 py-1">
          <div className="float-right flex items-center columns-2">
            <div style={{cursor: "default"}} className="text-sm mr-2 text-orange-400">7:02 pm</div>
            <div className="bg-orange-500 py-2 px-4 rounded-full">My name is Foo Bar</div>
          </div>
        </div>
        <div className="px-2 py-1">
          ...
          <div className="float-left flex items-center columns-2">
            <div className="bg-orange-700 py-2 px-4 rounded-full">Hello!</div>
            <div style={{cursor: "default"}} className="text-sm ml-2 text-orange-400">7:02 pm</div>
          </div>
        </div>
        <div className="px-2 py-1">
          <div className="invisible">
          ...
          <div className="float-left flex items-center columns-2">
            <div className="bg-orange-700 py-2 px-4 rounded-full">I'm doing great</div>
            <div style={{cursor: "default"}} className="text-sm ml-2 text-orange-400">7:03 pm</div>
          </div>
        </div>
        <div className="px-2 py-1">
          <div>
          ...
          <div className="float-left flex items-center columns-2">
            <div className="bg-orange-700 py-2 px-4 rounded-full">My name is Bar Foo!</div>
            <div style={{cursor: "default"}} className="text-sm ml-2 text-orange-400">7:03 pm</div>
          </div>
        </div>
      </div>
        ...
        <div className="py-4">
              <form className="max-w mx-12">   
                  ...
                  <div className="relative">
                      <input type="message" className="block w-full px-4 py-2 ps-4 text-md text-orange-300 border border-orange-300 rounded-full bg-black focus:ring-orange-500 focus:border-orange-500 dark:bg-orange-900 dark:border-orange-600 dark:placeholder-orange-400 dark:text-orange-100 dark:focus:ring-orange-500 dark:focus:border-orange-500" placeholder="Message..." required />
                  </div>
              </form>
          </div>
      </div>
    ...
    <aside id="default-sidebar" className="fixed rows-2 border-l border-l-orange-200 top-0 right-0 z-40 w-3/12 h-screen transition-transform -translate-x-full sm:translate-x-0 bg-black" aria-label="Sidebar">
    ...
    <div className="top-0 left-0 w-9/12 h-screen py-4 px-8 flex flex-col bg-black">
      <div className="basis-2/12 flex items-center justify-center">
          <div className="flex mr-8 pt-2 pb-8 gap-4">
          ...
          <div className="text-4xl font-black pt-2 pb-8 text-orange-800">Events</div>
