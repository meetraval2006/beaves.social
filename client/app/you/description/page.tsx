    ...
    <div className="min-h-screen bg-gray-100 py-12 px-4 sm:px-6 lg:px-8">
      <div className="relative">
        <div className="absolute top-2 left-2 flex gap-4">
          <button className="transition rounded-full ease-in-out bg-blue-500 hover:-translate-y-5 hover:scale-110 hover:bg-indigo-500 duration-300 p-2 flex-initial" onClick={() => redirect("/you/home")}>
