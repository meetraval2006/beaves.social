...
export default function Home() {
  return (
    ...
    <aside id="default-sidebar" className="fixed rows-2 border-r border-r-orange-200 top-0 left-0 z-40 w-96 h-screen transition-transform -translate-x-full md:translate-x-0 bg-black" aria-label="Sidebar">
    ...
    <div className="p-4 sm:ml-96 flex h-screen bg-black">
